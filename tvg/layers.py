...
class GraphConvolution(Layer):
    ...
    def _call(self, inputs):
        ...
        for i in range(len(self.support)):
            ...
            print('layers---before dot,self.support[i]',self.support[i].get_shape())
            print('pre_sup.shape:',pre_sup.shape)
